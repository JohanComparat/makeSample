...
p.savefig(join(os.environ['HOME'], 'wwwDir/sdss/elg/dr5/N_ra_ks_test.png'))
p.clf()
# dec figure
p.figure(1, (5,5))
...
p.grid()
p.legend(loc=0, frameon=False)
p.savefig(join(os.environ['HOME'], 'wwwDir/sdss/elg/dr5/N_dec_ks_test.png'))
p.clf()
# ra-dec figure
p.figure(1, (5,5))
...
p.ylabel('dec')
#p.legend(loc=0, frameon=False)
p.savefig(join(os.environ['HOME'], 'wwwDir/sdss/elg/dr5/N_sky_ks_test_D.png'))
p.clf()
...
p.ylabel('dec')
#p.legend(loc=0, frameon=False)
p.savefig(join(os.environ['HOME'], 'wwwDir/sdss/elg/dr5/N_sky_ks_test_R.png'))
p.clf()
...
p.grid()
p.legend(loc=0, frameon=False)
p.savefig(join(os.environ['HOME'], 'wwwDir/sdss/elg/dr5_2/N_ra_ks_test.png'))
p.clf()
# dec figure
p.figure(1, (5,5))
N_dec_data, bb, ptxs = p.hist(dec_data[sel_data], normed=True, cumulative=True, bins=1000, histtype='step', label='data ')
...
p.grid()
p.legend(loc=0, frameon=False)
p.savefig(join(os.environ['HOME'], 'wwwDir/sdss/elg/dr5_2/N_dec_ks_test.png'))
p.clf()
# ra-dec figure
p.figure(1, (5,5))
p.plot(ra_rds[sel_rds], dec_rds[sel_rds], 'k,', rasterized=True)
...
p.ylabel('dec')
#p.legend(loc=0, frameon=False)
p.savefig(join(os.environ['HOME'], 'wwwDir/sdss/elg/dr5_2/N_sky_ks_test_D.png'))
p.clf()
...
p.ylabel('dec')
#p.legend(loc=0, frameon=False)
p.savefig(join(os.environ['HOME'], 'wwwDir/sdss/elg/dr5_2/N_sky_ks_test_R.png'))
p.clf()
