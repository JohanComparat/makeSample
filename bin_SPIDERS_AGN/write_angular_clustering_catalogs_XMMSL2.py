...
# catalogs :
data_file = join( in_dir, 'XMMSL2_AllWISE_catalog_paper_2017JUN09_v5_11_0_sdss_26_VERON_MASKED.fits' )
...
out_data = os.path.join(out_dir , 'XMMSL2_AllWISE_catalog_paper_2017JUN09_X_GAL.data')
...
out_rds = os.path.join(out_dir , 'XMMSL2_AllWISE_catalog_paper_2017JUN09_X_GAL.random')
