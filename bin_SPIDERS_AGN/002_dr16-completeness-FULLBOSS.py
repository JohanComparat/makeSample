...
prefix='FULL_BOSS_2RXS_ExiML'+EXI_ML_min_str+'_'
...
path_2_cat_2RXS = os.path.join(catalog_dir, '2RXS', 'SPIDERS_2RXS_Xray_NWAY_ALLWISE_SDSSv5b_SpecDR16_archivalVI_FIRST_GaiaDR2.fits')
path_2_cat_xmmsl = os.path.join(catalog_dir, 'XMMSL2',  'SPIDERS_XMMSL2_Xray_NWAY_ALLWISE_SDSSv5b_SpecDR16_archivalVI_FIRST_GaiaDR2.fits')
...
idZ = (observed) & ( (data['DR16_Z']>-0.5) & (data['DR16_Z_ERR']>0) ) & (data['DR16_SN_MEDIAN_ALL']>=2) & (data['DR16_ZWARNING']==0 )
...
clusters = (goodZ) & (class_best=='GALAXY')
stars = (goodZ) & (class_best=='STAR')
agnZ = (goodZ) & (class_best=='QSO')
