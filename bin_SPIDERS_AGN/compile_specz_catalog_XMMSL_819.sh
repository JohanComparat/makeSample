...
# input catalog
CAT_IN=/data36s/comparat/SDSS/dr14/spiders/target/spiderstargetAGN-SPIDERS_XMMSL_AGN-v3.1-hdu2.fits
...
# final output name
CAT_SPEC=/data36s/comparat/AGN_clustering/catalogs/spiderstargetAGN-SPIDERS_XMMSL_AGN-v3.1_v5_13_0_sdss_26_VERON_2QZ.fits 

# masking the final catalog
CAT_SPEC_MASKED=/data36s/comparat/AGN_clustering/catalogs/spiderstargetAGN-SPIDERS_XMMSL_AGN-v3.1_v5_13_0_sdss_26_VERON_2QZ_MASKED.fits 
