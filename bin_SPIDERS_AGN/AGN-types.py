...
#def get_arrays(path_2_cat, EXI_ML_min = EXI_ML_min):
	...
	#idZ =  (c2) | (c3) | (c4) | (c5) | (c6) 
	#clusters = (abs(data['DR16_Z'] - data['REDMAPPER_Z_LAMBDA'])<0.1)
	...
	#return data[(observed)], ra[(observed)], dec[(observed)], targeted[(observed)], observed[(observed)], goodZ[(observed)], idZ[(observed)], agnZ[(observed)], clusters[(observed)], blazars_noZ[(observed)], stars[(observed)], hd_rass_i
...
#c1 = ( (data['Z_BEST']>-0.5) | (data['DR16_Z']>-0.5) )
#c2 = (c1) & (data['CONF_BEST']==3)
#c3 = (c1) & (data['CONF_BEST']==2) & ((data['CLASS_BEST']=='BLAZAR')|(data['CLASS_BEST']=='BLLAC'))
#c4 = (c1) & (data['DR16_SN_MEDIAN_ALL']>=2) & (data['DR16_ZWARNING']==0 )
#c5 = (c1) & (data['CONF_BEST']==2) & (data['DR16_ZWARNING']<=4 ) & (data['VI_REINSPECT_FLAG'] == 0) & (data['VI_NINSPECTORS']>2)
#c6 = (c1) & (data['CONF_BEST']==2) & (data['DR16_ZWARNING']<=4 ) & (data['VI_AM_RECONCILED']==1)
