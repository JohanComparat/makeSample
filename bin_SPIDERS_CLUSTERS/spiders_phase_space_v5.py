...
n.savetxt(os.path.join(os.environ['DATA_DIR'], 'spiders', 'cluster', 'phase-space_v5.dat'), ttt)

sys.exit()

dz_i, radius_i, mass_i, age_i = n.loadtxt(os.path.join(os.environ['DATA_DIR'], 'spiders', 'cluster', 'phase-space_v5.dat'))
