...
spm = fits.open(os.path.join(dir, 'FireFly_mag_v5_10_0.fits'))
...
os.system( 'rm '+os.path.join(dir, 'CODEX-DR14-MergedSpectroscopicCatalogue_2018-02-05-spmv5.fits') )
thdulist.writeto(os.path.join(dir, 'CODEX-DR14-MergedSpectroscopicCatalogue_2018-02-05-spmv5.fits') )
