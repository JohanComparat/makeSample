...
p.plot(x_out, n.log10(c_out_magneticum), 'm', rasterized = True, label = 'Magneticum LX500 WMAP7' )
...
p.plot(10**x_out, c_out_magneticum, 'm', rasterized = True, label = 'Magneticum LX500 WMAP7' )
