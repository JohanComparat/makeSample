...
hdu_header_prefix = n.array(["Chabrier_MILES_", "Chabrier_ELODIE_", "Salpeter_MILES_UVextended_" ])
...
chi2 = n.ones((len(orig_table['MJD']),3))*dV
ndof = n.ones((len(orig_table['MJD']),3))*dV
