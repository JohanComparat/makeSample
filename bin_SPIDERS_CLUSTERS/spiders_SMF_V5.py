...
DATA = [] 
for cc in cat:
	delta_z, sep_r200c, stellar_mass , is_mem, ages, vol, z_gal = get_props(cc, spmV5, 'Z_NOQSO')
	mem = (is_mem==1)
...
n.savetxt(os.path.join(os.environ['DATA_DIR'], 'spiders', 'cluster', 'SMF_v5.dat'), ttt)
